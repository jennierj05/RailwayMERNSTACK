   ...
   >
      ...
      <div className="row">
        <div className="col-md-6 offset-md-3 text-center">
          <p className="lead">Your one-stop destination for railway services and more.</p>
          ...
          <Button className="btn btn-success mx-2" onClick={click3}>
            PNR ENQUIRY
          </Button>
        </div>
      </div>
      <footer className="fixed-bottom">
        <div className="container d-flex flex-column align-items-center">
          <div className="mt-3">
            <p className="copyright">© 2023 IRCTC</p>
          </div>
        </div>
      </footer>
      </div>
